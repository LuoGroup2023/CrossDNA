...
# Default settings
# You can run:
#   bash gb_crossdna.sh human_enhancers_cohn
#
# Optional override:
#   bash gb_crossdna.sh human_enhancers_cohn /new/pretrain.ckpt /new/data/root
# --------------------------------------------------
...
WANDB_NAME="gb_crossdna_${DATASET_NAME}_len-${MAX_LENGTH}_dmodel-${D_MODEL}_depth-${DEPTH}_lr-${LR}_bs-${BATCH_SIZE}"
...
ARGS=(
    ...
    wandb.group=crossdna_gb_finetune
    wandb.mode=online
    wandb.id=${WANDBID}
